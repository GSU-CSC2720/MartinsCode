...
public class Rational
{
    ...
    public Rational(int n, int d)
    {
        if(d == 0)
        {
            throw new ZeroDenominatorException("Undefined");
        }
        else
        {
          numerator = n;
    ...
    {               
        // CHANGE THE RETURN TO SOMETHING APPROPRIATE
        return new Rational(-numerator,Math.abs(denominator));
    }
    ...
    {       
        ...
        int x = (numerator*other.denominator)+(other.numerator*denominator);
        int y = other.denominator * denominator;
 ...
 /**
    ...
    private void normalize()
    {
        ...
        int result = gcd(Math.abs(n),denominator);
