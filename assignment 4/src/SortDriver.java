...
public class SortDriver
{
    ...
    public static void main(String args[])
    {
        ...
        System.out.println("   Total comparison made: "+sai.getTotalComparisons());
        System.out.println("   Minimum comparison made: "+sai.getMinComparisons());
        System.out.println("   Maximum comparison made: "+sai.getMaxComparisons());
        System.out.println("   Average number of comparisons: "+sai.getTotalComparisons()/trials);
